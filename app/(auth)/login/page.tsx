...
export default function LoginPage() {
  ...
  return (
    <div className="bg-surface rounded-2xl border border-border p-6 space-y-4">
      <h2 className="font-bold text-xl">Iniciar sessão</h2>
      ...
      <div className="grid grid-cols-2 gap-3">
        <button
          ...
          className="flex items-center justify-center gap-2 bg-surface-2 border border-border rounded-xl py-2.5 text-sm hover:bg-surface-3 transition-colors"
        >
      ...
      <p className="text-center text-sm text-muted">
        Sem conta?{' '}
        <Link href="/register" className="text-gold hover:underline">Criar conta</Link>
      </p>
    </div>
  )
}
